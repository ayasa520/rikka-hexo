...
+ 斯皮尔曼( Spearman ) 相关系数:
  ...
  <div style="text-align:center"><img src="https://npm.elemecdn.com/rikka-os@1.0.3/img/image-20210502235007093.webp" alt="image-20210502235007093" style="zoom:67%;" /></div>
...
<div style="text-align:center"><img src="https://npm.elemecdn.com/rikka-os@1.0.3/img/image-20210502235759134.webp" alt="image-20210502235759134" style="zoom:67%;" /></div>
...
<div style="text-align:center"><img src="https://npm.elemecdn.com/rikka-os@1.0.3/img/image-20210503000648946.webp" alt="image-20210503000648946" style="zoom:67%;" /></div>

各个样本间是独立的, 则

<div style="text-align:center"><img src="https://npm.elemecdn.com/rikka-os@1.0.3/img/image-20210503000737757.webp" alt="image-20210503000737757" style="zoom:67%;" /></div>
...
单因素试验方差分析表:
<img src="https://npm.elemecdn.com/rikka-os@1.0.3/img/image9.webp" style="zoom:100%;" alt="单因素试验方差分析表"/>

例: 保险公司为了解某一险种在四个不同地区索赔额情况是否存在差异。搜集了这四个不同地区一年的索赔额情况记录如表所示. 试判断在四个不同地区索赔额有无显著的差异?

<img src="https://npm.elemecdn.com/rikka-os@1.0.3/img/image (19).webp" style="zoom:100%;" alt=""/>
...
+ 最终的方差分析表:
  ...
  <img src="https://npm.elemecdn.com/rikka-os@1.0.3/img//image (29).webp" style="zoom:100%;" />
...
+ 作 $\mu_i - \mu_j(i \ne j)$ 的区间估计
  ...
  <div style="text-align:center"><img src="https://npm.elemecdn.com/rikka-os@1.0.3/img/image-20210503001132577.webp" alt="image-20210503001132577" style="zoom:50%;" /></div>
...
<div style="text-align:center"><img src="https://npm.elemecdn.com/rikka-os@1.0.3/img/image-20210503001402429.webp" alt="image-20210503001402429" style="zoom:67%;" /></div>

$A,B,C$ 下每个单元格内容为该因素的水平.

<div style="text-align:center"><img src="https://npm.elemecdn.com/rikka-os@1.0.3/img/image-20210503001443516.webp" alt="image-20210503001443516" style="zoom:50%;" /></div>
