...
- 同轴电缆 (Coaxial Cable)
  ...
  ![image-20210323110924035](https://npm.elemecdn.com/rikka-os@1.0.3/img/RiBqmbxIPlUMu2a.webp)
...
- 双绞线 (Twisted Pair)
  ...
  <img src="https://npm.elemecdn.com/rikka-os@1.0.3/img/lu6VJF1eTk2MOdi.webp" alt="image-20210323113124867" style="zoom:100%;margin-left : 5%" /><img src="https://npm.elemecdn.com/rikka-os@1.0.3/img/Bf2qN4vItKspmF6.webp" alt="image-20210323113156980"  style=""/>
...
- 光纤 (Fiber-Optic)
  ...
  ![image-20210323115529271](https://npm.elemecdn.com/rikka-os@1.0.3/img/pD6ikyuJhcZKarE.webp)
  ...
  - 原理
    ...
    ![image-20210323120036566](https://npm.elemecdn.com/rikka-os@1.0.3/img/jzHMdTBw8namWJu.webp)

  - 多模光纤和单模光纤对比

    ![image-20210323120357496](https://npm.elemecdn.com/rikka-os@1.0.3/img/goqf63t2PQUFJbY.webp)
...
![image-20210323120834212](https://npm.elemecdn.com/rikka-os@1.0.3/img/wDPgsdQHKL2VuBn.webp)

#### 并行传输

n 条线路同时传输

![image-20210323120858286](https://npm.elemecdn.com/rikka-os@1.0.3/img/UvmTDg27ZxiB8bR.webp)
...
![image-20210323210341109](https://npm.elemecdn.com/rikka-os@1.0.3/img/QoWF4TN5PnyuJK2.webp)
...
![image-20210323210808220](https://npm.elemecdn.com/rikka-os@1.0.3/img/3UiGa9MN7Bdwvze.webp)
...
![image-20210323184729955](https://npm.elemecdn.com/rikka-os@1.0.3/img/fUZKHsvNIA24j3w.webp)

### 码元

在使用时间域的波形表示数字信号时, 代表不同**离散数值的基本波形**. 例:

![image-20210323185320323](https://npm.elemecdn.com/rikka-os@1.0.3/img/GQIJoFsUTafv2HR.webp)
...
![image-20210323185911303](https://npm.elemecdn.com/rikka-os@1.0.3/img/cX3aD14ZQYT9Us6.webp)
...
![image-20210323190136435](https://npm.elemecdn.com/rikka-os@1.0.3/img/RUEdWMaY7ZrHc64.webp)
...
![image-20210323193034084](https://npm.elemecdn.com/rikka-os@1.0.3/img/7oQUkKR4jyluFhe.webp)
...
![image-20210323193704659](https://npm.elemecdn.com/rikka-os@1.0.3/img/EnGlsBzAZP1jxNr.webp)
...
- QAM-16
  ...
  - 每种相位有1或者2种振幅可选
    ...
    ![image-20210323194351345](https://npm.elemecdn.com/rikka-os@1.0.3/img/vUuIPcdaFirHzwB.webp)
  ...
  - 码元与4个比特的对应关系采用格雷码. 相邻码元只有一位不同
    ...
    ![image-20210323195043588](https://npm.elemecdn.com/rikka-os@1.0.3/img/sWGj8y2hFnx6arN.webp)
...
![image-20210323200241813](https://npm.elemecdn.com/rikka-os@1.0.3/img/LbXHw1NaI4pTGhA.webp)
