...
<img src="https://npm.elemecdn.com/rikka-os@1.0.3/img/README.assets/3ee2f36bb8d10c7aa8595477a7d7bc38efd76b3d.jpg" alt="半导体存储器类型" style="zoom:80%;" />
...
<img src="https://npm.elemecdn.com/rikka-os@1.0.3/img/README.assets/3d8110ac2957078f247f7fc6725310962f39e43b.jpg" alt="DRAM" style="zoom:80%;" />
...
+ 用传统的触发逻辑门配置存储数据
  + 处理器中使用了相同的逻辑单元
+ 只要供应电力就能一直保存数据(无需刷新)
  <img src="https://npm.elemecdn.com/rikka-os@1.0.3/img/README.assets/83a86f458af7b30ca04aca27502cbe704f02e2be.jpg" alt="SRAM" style="zoom:80%;" />
...
+ 传统的 DRAM 是异步的.
  ...
  + 由于SDRAM随系统时钟移动数据,CPU 知道数据何时能够准备好.
    <img src="https://npm.elemecdn.com/rikka-os@1.0.3/img/README.assets/pqxwjrSud5agc4m.jpg" alt="SDRAM" style="zoom:67%;" />
...
+ DDR 技术的更迭
  + 提升操作频率
  + 提升预取缓冲器位数
    <img src="https://npm.elemecdn.com/rikka-os@1.0.3/img/README.assets/3308197023c32a8fa15623c9601b5a9039fd8d96.webp" alt="DDR" style="zoom:67%;" />
...
+ **存储阵列**(Memory array)
  + 由许多存储单元组成(如下图中有$2048\times 2048$个存储单元)
    <img src="https://npm.elemecdn.com/rikka-os@1.0.3/img/README.assets/7efdd71a9827da9b5f3a4d6854acdea6ecdc13a3.webp" alt="RAM" style="zoom:67%;" />
