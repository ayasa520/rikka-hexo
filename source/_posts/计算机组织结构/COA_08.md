...
+ 数据位划分
  ...
  + 关系如下
    <img src="https://unpkg.zhimg.com/rikka-os@latest/img/README.assets/2baad364b5a440170c2aa4414d5a2e8c5a2a7f1f.jpg"/>
    数据在传输的时候也正是这样穿插进行的
  + 数据位划分
    $$\begin{aligned}
...
+ 过程:
  ...
  + 进行模二取余的除法运算, 具体过程如下图:
    <img src="https://unpkg.zhimg.com/rikka-os@latest/img/README.assets/42ae5b4ac3450a3bf179f67b6827527ba37e9b7c.gif@518w.gif"/>
+ 检查:
