...
1. 对阶
   ...
   1. 求阶差
      ...
      <img src="https://unpkg.zhimg.com/rikka-os@1.0.3/img/README.assets/deb6114c1afee838908c5071612f84f69a0fa8d0.jpg" alt="浮点数加减" style="zoom:67%;" />
...
+ 如果两个操作数符号相同,做加法,否则做减法.
  ...
  + 减法:加第二个数的补数
    ...
    + 若没有进位,应该取结果的补数,最终结果与被减数相反.
      ...
      <img src="https://unpkg.zhimg.com/rikka-os@1.0.3/img/README.assets/baa713a920ac0acf967f9b22dda0cc73973d0598.webp" alt="浮点数运算源码加减法" style="zoom:80%;" />
...
<img src="https://unpkg.zhimg.com/rikka-os@1.0.3/img/README.assets/16896fbb58f26550525aedbf82281f8eec4abede.jpg" alt="浮点数乘" style="zoom:67%;" />
...
<img src="https://unpkg.zhimg.com/rikka-os@1.0.3/img/README.assets/2489c91543786aa46bdfc31c6d4f6b1851450557.jpg" alt="浮点数除法" style="zoom:67%;" />
