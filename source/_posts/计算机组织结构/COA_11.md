...
+ 菊花链
  ...
  **劣势:**无法兼顾公平性, 对设备故障敏感, 限制了总线速度
  ...
  <img src = "https://unpkg.zhimg.com/rikka-os@1.0.3/img/README.assets/ad9ccc3d658ce27417fa4964c61f7b2b52890852.webp">
...
+ 计数器查询
  ...
  **劣势:**增加了 ID 线, 需要解码和比较 ID 信号
  ...
  ![](https://unpkg.zhimg.com/rikka-os@1.0.3/img/README.assets/97b8bcebc5718ccae167c8a765ba5a92d06b55d6.webp)
...
+ 独立请求
  ...
  **劣势:**控制逻辑复杂, 更多的控制线
  ...
  ![](https://unpkg.zhimg.com/rikka-os@1.0.3/img/README.assets/c4c6d3ea6471ed7ad051062bced6132865d48487.webp)
...
+ 自举式
  ...
  ![](https://unpkg.zhimg.com/rikka-os@1.0.3/img/README.assets/dfebd1c7b50dd3f714b0ee0e58f6fcd438fb8c22.webp)
...
+ **异步时序**: 总线上一个事件的发生遵循并取决于前一个事件的发生
  ...
  ![](https://unpkg.zhimg.com/rikka-os@1.0.3/img/README.assets/02a74fd69a419c5ef9bcf0e77b23edcd281803c1.webp)

  **握手**的样例: 

   ![](https://unpkg.zhimg.com/rikka-os@1.0.3/img/README.assets/27998c3a8bb48f3970e1eaf868e837d52094e858.webp)				

   ![](https://unpkg.zhimg.com/rikka-os@1.0.3/img/README.assets/27babc06420cc8c0e436f97540af8e5e784e388b.webp)
...
+ 半同步时序: 结合同步时序(时钟)和异步时序(握手)
  ...
  ![](https://unpkg.zhimg.com/rikka-os@1.0.3/img/README.assets/ce326c52f5da9ded6538dbd707f812facba524ea.webp)
...
+ 分割事务: 分割总线事务: 当设备准备好数据时释放总线
  ...
  **缺点:**增加了每个总线事务的持续时间和系统复杂性
  ...
  ![](https://unpkg.zhimg.com/rikka-os@1.0.3/img/README.assets/a44f52cef72189278f36692269324130069b39d4.webp)
